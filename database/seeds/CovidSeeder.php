...
class CovidSeeder extends Seeder
{
    ...
    public function run()
    {
        $covids = array(
            ...
            array('name' => 'Is your throat sore?', 'screening_type_id' => 2, 'image_path' => 'questions/throat.jpeg'),
        );
        ...
        $screenings = array(
            ...
            array('appointment_id' => 1, 'screening_questionnaire_id' => 4, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
            array('appointment_id' => 1, 'screening_questionnaire_id' => 5, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
            array('appointment_id' => 1, 'screening_questionnaire_id' => 6, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
            ...
            array('appointment_id' => 2, 'screening_questionnaire_id' => 4, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
            array('appointment_id' => 2, 'screening_questionnaire_id' => 5, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
            array('appointment_id' => 2, 'screening_questionnaire_id' => 6, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
            ...
            array('appointment_id' => 3, 'screening_questionnaire_id' => 4, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
            array('appointment_id' => 3, 'screening_questionnaire_id' => 5, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
            array('appointment_id' => 3, 'screening_questionnaire_id' => 6, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
            ...
            array('appointment_id' => 4, 'screening_questionnaire_id' => 4, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
            array('appointment_id' => 4, 'screening_questionnaire_id' => 5, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
            array('appointment_id' => 4, 'screening_questionnaire_id' => 6, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
            ...
            array('appointment_id' => 5, 'screening_questionnaire_id' => 4, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
            array('appointment_id' => 5, 'screening_questionnaire_id' => 5, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
            array('appointment_id' => 5, 'screening_questionnaire_id' => 6, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
            ...
            array('appointment_id' => 6, 'screening_questionnaire_id' => 4, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
            array('appointment_id' => 6, 'screening_questionnaire_id' => 5, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
            array('appointment_id' => 6, 'screening_questionnaire_id' => 6, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
            ...
            array('appointment_id' => 7, 'screening_questionnaire_id' => 4, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
            array('appointment_id' => 7, 'screening_questionnaire_id' => 5, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
            array('appointment_id' => 7, 'screening_questionnaire_id' => 6, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
            ...
            array('appointment_id' => 8, 'screening_questionnaire_id' => 4, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
            array('appointment_id' => 8, 'screening_questionnaire_id' => 5, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
            array('appointment_id' => 8, 'screening_questionnaire_id' => 6, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
            ...
            array('appointment_id' => 9, 'screening_questionnaire_id' => 4, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
            array('appointment_id' => 9, 'screening_questionnaire_id' => 5, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
            array('appointment_id' => 9, 'screening_questionnaire_id' => 6, 'screening_date' => Carbon::now(),'screening_answer' => $answers[rand(0,1)]),
        );
