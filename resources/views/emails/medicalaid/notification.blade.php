...
@section('content')
    <div class="card">
        <div class="card-body">
            Dear {{$medicalAid[0]->medical_name}},<br><br>

            Please find the invoice of {{$appointment->patient->full_name}}.<br>
            Medical Aid Number {{$medicalAid[0]->medical_aid_number}}.<br>
            ...
            <table class="table table-striped table-bordered">
                ...
                @foreach($appointment->prescriptions as $prescription)
                    <tr>
                        ...
                        <td class="text-right">R {{$prescription->clinicProduct->price}}</td>
